...
from models import Student, Lecturer, DocumentSignature
import logging
...
{lecturer_name} has uploaded new material. Please view them.

Material: {material_title}

Please log in to SDMIT Nexus to access the new material.
