...
def evaluate_embeddings(people_embeddings, test_pairs, single_image_mode=False):
    ...
    for a, b, label in test_pairs:
        try:
            ...
            _, pred = compare_embeddings(emb1, emb2)
            y_true.append(label)
            y_pred.append(pred)
...
if __name__ == "__main__":
    ...
    dataset = {
        ...
        "person5": ["dataset/person5_img1.jpeg", "dataset/person5_img2.jpeg","dataset/person5_img3.jpeg"],
        "person6": ["dataset/person6_img1.jpeg","dataset/person6_img2.jpeg","dataset/person6_img3.jpeg"],
        "person7": ["dataset/person7_img1.jpeg","dataset/person7_img2.jpeg","dataset/person7_img3.jpeg"],
        "person8": ["dataset/person8_img1.jpeg","dataset/person8_img2.jpeg","dataset/person8_img3.jpeg"],
    ...
    test_pairs_single = [
        ...
        ("dataset/person5_img1.jpeg","person5",1),
        ("dataset/person5_img2.jpeg","person5",1),
        ("dataset/person5_img3.jpeg","person5",1),
        ("dataset/person1_img1.jpeg","person5",0),
        ("dataset/person2_img2.jpeg","person5",0),
        ("dataset/person3_img3.jpeg","person5",0),

        ("dataset/person6_img1.jpeg","person6",1),
        ("dataset/person6_img2.jpeg","person6",1),
        ("dataset/person6_img3.jpeg","person6",1),
        ("dataset/person2_img1.jpeg","person6",0),
        ("dataset/person3_img2.jpeg","person6",0),
        ("dataset/person4_img3.jpeg","person6",0),

        ("dataset/person7_img1.jpeg","person7",1),
        ("dataset/person7_img2.jpeg","person7",1),
        ("dataset/person7_img3.jpeg","person7",1),
        ("dataset/person1_img2.jpeg","person7",0),
        ("dataset/person4_img1.jpeg","person7",0),
        ("dataset/person6_img2.jpeg","person7",0),

        ("dataset/person8_img1.jpeg","person8",1),
        ("dataset/person8_img2.jpeg","person8",1),
        ("dataset/person8_img3.jpeg","person8",1),
        ("dataset/person3_img1.jpeg","person8",0),
        ("dataset/person5_img2.jpeg","person8",0),
        ("dataset/person7_img3.jpeg","person8",0)
