...
class Student(Base):
    ...
    student_doubts = relationship("DoubtClarification", back_populates="student", cascade="all, delete-orphan")
...
class Lecturer(Base):
    ...
    study_materials = relationship("StudyMaterial", back_populates="uploader")
    events = relationship("Event", back_populates="creator")
    documents = relationship("Document", back_populates="uploader", cascade="all, delete-orphan")
    lecturer_doubts = relationship("DoubtClarification", back_populates="lecturer", cascade="all, delete-orphan")
...
class Event(Base):
    ...
    group_id = Column(Integer, ForeignKey("groups.group_id", ondelete="CASCADE"))
    created_by = Column(Integer, ForeignKey("lecturers.lecturer_id", ondelete="CASCADE"))
    title = Column(String, nullable=False)
    content = Column(String, nullable=False)
    ...
    creator = relationship("Lecturer", back_populates="events")
...
class DoubtClarification(Base):
    ...
    sender_role = Column(Enum(RecipientRole), nullable=False)
    ...
    parent = relationship("DoubtClarification", remote_side=[doubt_id])
    student = relationship("Student", back_populates="student_doubts")
    lecturer = relationship("Lecturer", back_populates="lecturer_doubts")
