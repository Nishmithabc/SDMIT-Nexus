...
async def upload_document(
    ...
    # ✅ Use background_tasks properly
    background_tasks.add_task(email_service.send_document_notification, db, group_id, author_name, title)
    background_tasks.add_task(broadcast_document, group_id, document_data)

    # Schedule reminder (can also use background if needed)
