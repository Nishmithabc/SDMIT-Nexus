...
from models import DoubtClarification, StudyMaterial, Event, Document, Lecturer, Student,LecturerGroup,RecipientRole,Group
...
def get_group_members(group_id: int, db: Session = Depends(get_db)):
    ...
    lecturers = [
        {
            "id": lecturer_group.lecturer.lecturer_id,
            "name": lecturer_group.lecturer.name,
        }
        for lecturer_group in group.lecturers
    ]
