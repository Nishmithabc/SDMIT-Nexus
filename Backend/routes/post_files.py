...
async def create_announcement(
    ...
    announcement_data={
        ...
        "content": content,
        "type": type,
        "uploader_id":db_ann.uploaded_by if type=="material" else db_ann.created_by,
        "author": author_name,
    ...
    if type == "material":
        background_tasks.add_task(email_service.send_material_notification, db, group_id, author_name, title)
    elif type == "event":
        background_tasks.add_task(email_service.send_event_notification, db, group_id, author_name, title)
