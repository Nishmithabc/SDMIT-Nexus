...
export default function FaceRegistration() {
  ...
  const availablePrompts = ["Smile", "Slightly Turn Left", "Slightly Turn Right"]
...
async function encryptBlob(blob: Blob, key: CryptoKey) {
  ...
  <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
    <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-lg w-[90%] max-w-md p-6 text-center animate-fadeIn">
      <h2 className="text-xl font-semibold mb-3 text-gray-800">📸 Face Registration Disclaimer</h2>
      <p className="text-sm text-gray-700 text-left leading-relaxed mb-4">
        Please ensure there is <b>good lighting</b> and that you capture a clear image of your face.  
        Do <b>not attempt to prank</b> by using another student’s image. The images you upload are 
        directly used for <b>comparison during digital signing and verification</b>.  
        It’s important to maintain high image quality to avoid errors during authentication.  
        All captured data is <b>securely stored and encrypted</b>.
      </p>
