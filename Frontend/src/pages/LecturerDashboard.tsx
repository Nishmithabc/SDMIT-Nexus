...
const fetchGroupStats = async () => {
  ...
  // ---------------------- AUTH & ACCESS CONTROL ----------------------
  useEffect(() => {
    console.log("Lecturer access check →", {
    user,
    lecturerGroups: user?.groups,
...
<TabsContent value="discussion">
  ...
  />
                      ...
                      <CardDescription>{ann.author||"Lecturer"} • {safeFormat(ann.timestamp, "MMM dd, yyyy HH:mm")}</CardDescription>
                    </CardHeader>
                    <CardContent>
...
/>)}
              ...
              <CardDescription>
                Uploaded by {doc.author_name||"Lecturer"} •{" "}
