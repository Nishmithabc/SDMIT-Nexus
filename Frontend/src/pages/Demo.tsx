...
export default function Demo() {
  ...
  <Card className="max-w-5xl mx-auto bg-gradient-primary/5 border-primary/20 shadow-medium">
    <CardHeader className="text-center">
      <div className="flex items-center justify-center space-x-2 mb-2">
        <FileText className="h-7 w-7 text-primary" />
        <CardTitle className="text-3xl font-semibold">Instructions to Use the Platform</CardTitle>
      </div>
      <CardDescription className="text-lg text-muted-foreground">
        Follow these steps to effectively use the SDMIT Nexus web application.
      </CardDescription>
    </CardHeader>

    <CardContent className="text-left px-8 py-6 space-y-5 text-lg leading-relaxed">
      <ol className="list-decimal list-inside space-y-4">
        <li>
          <strong>Sign Up or Log In:</strong> Use your institutional email to register or log in securely.
        </li>
        <li>
          <strong>Face Registration:</strong> Ensure proper lighting during registration. Avoid strong backlight or low brightness your face should be clearly visible for accurate recognition.
        </li>
        <li>
          <strong>Digital Signature:</strong> Before signing, complete the active liveness check by following the on-screen prompts . Once verified, System proceeds with document signing.
        </li>
        <li>
          <strong>Access Your Dashboard:</strong> Students can join group discussions, view shared materials, and sign important academic documents digitally.
        </li>
        <li>
          <strong>For Lecturers:</strong> Manage classes, upload study materials, and monitor student participation seamlessly.
        </li>
        <li>
          <strong>For Admins:</strong> Oversee overall system activity, manage user access, and track institutional data insights.
        </li>
        <li>
          <strong>Stay Updated:</strong> Receive instant notifications about announcements, deadlines, and upcoming events.
        </li>
        <li>
          <strong>Need Help?</strong> Use the in-app support option or contact your department administrator for assistance.
        </li>
      </ol>
    </CardContent>
  </Card>
